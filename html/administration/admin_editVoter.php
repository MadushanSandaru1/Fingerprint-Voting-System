...
<?php
    ...
    if(isset($_GET['id'])){
        $_SESSION['editVoterId'] = $_GET['id'];
    }

    $query = "SELECT * FROM `voter` WHERE `nic` = '{$_SESSION['editVoterId']}' AND `is_deleted` = 0 LIMIT 1";
    ...
    if (mysqli_num_rows($result_set) >= 1) {
        ...
        while($party = mysqli_fetch_assoc($result_set)){
            ...
            $email = $party['email'];
            $fingerprintL = $party['fingerprint_L'];
            $fingerprintR = $party['fingerprint_R'];
        }
    }
	...
	if(isset($_POST['saveBtn'])) {
        ...
        $query = "UPDATE `voter` SET `name` = '{$name}', `contact` = '{$contact}', `b_day` = '{$bDay}', `gender` = '{$gender}', `email` = '{$email}', `fingerprint_R` = '{$fingerprintR}', `fingerprint_L` = '{$fingerprintL}', `divi_id` = {$diviId}, `language` = '{$language}' WHERE `nic` = '{$_SESSION['editVoterId']}'";
            ...
            <main class="page-content">
                <div class="container">
                    ...
                    <div class="row topic">
                        ...
                        <div class="col-md-11">
                            <span class="font-weight-bold"><big>Edit Voter</big><br><small>Voter</small></span>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 form">
                            ...
                            <br><hr><br>
                            <!-- Form -->
                            <form action="admin_editVoter.php" method="post">
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label"><strong>NIC <sup><i class="fas fa-asterisk fa-xs"  style="color:red;"></i></sup></strong></label>
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control" name="nic" placeholder="NIC" value="<?php echo $_SESSION['editVoterId']; ?>" pattern="[0-9]{9}[Vv]" readonly required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control" name="contact" placeholder="Contact" value="<?php echo $contact; ?>" pattern="0[0-9]{9}" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control" name="fingerprintR" placeholder="Fingerprint - Right" value="<?php echo $fingerprintR; ?>" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control" name="fingerprintL" placeholder="Fingerprint - Left" value="<?php echo $fingerprintL; ?>" required>
                                    </div>
                                </div>
                                <div class="form-group row">
