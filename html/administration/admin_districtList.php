            ...
            <main class="page-content">
                <div class="container">
                    ...
                    <div class="row topic">
                        ...
                        <div class="col-md-11">
                            <span class="font-weight-bold"><big>District List</big><br><small>District</small></span>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12 form">
                            <div class="row">
                                <div class='col-md-9'>
                                    ...
                                    <a href='../../report/tcpdf_lib/examples/district_report_format.php' target="_blank"><button type='button' class='btn btn-outline-primary'><i class='far fa-file-alt'></i>  Get Report</button></a>
                                    <?php
                                        }
                                    ?>
                                ...
                                <div class="col-md-3">
                                    <form action="admin_districtList.php" method="get">
                            ...
                            <table class="table">
                              ...
                              <tbody>
                                  <?php
                                    ...
                                    $query = "SELECT d.*, p.`name` AS 'p_name' FROM `district` d, `province` p WHERE d.`prov_id` = p.`id`";
                                    ...
                                    if (mysqli_num_rows($result_set) >= 1) {
                                        ...
                                        while($division = mysqli_fetch_assoc($result_set)){
                                            ...
                                            echo "<td>".$division['prov_id']." - ".$division['p_name']."</td>";
