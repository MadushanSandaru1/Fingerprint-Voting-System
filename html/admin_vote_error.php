...
<html>
    <head>
        <title>FVS | Admin Vote Error</title>
        ...
        <div class="container">
            <div class="row rowCenter align-items-center">
                <div class="col-12 text-center mt-5">
                    <h1 class="fingerprint mt-5">පරිපාලකයාට ඡන්දය භාවිතා කළ නොහැක</h1>
                    <h1 class="fingerprint mt-4 mb-4">நிர்வாகி வாக்குகளைப் பயன்படுத்த முடியாது</h1>
                    <h1 class="fingerprint mt-4 mb-5">The administrator cannot use vote</h1>
                </div>
            </div>
        </div>
    </body>
