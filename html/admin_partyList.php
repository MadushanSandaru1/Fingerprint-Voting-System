                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-12 form">
                            <div class="row">
                                <div class='col-md-8'>
                                    <a href='admin_addParty.php' ><button type='button' class='btn btn-outline-primary'><i class='fas fa-plus'></i>  Add Party</button></a>
                                </div>
                                <div class="col-md-4">
                              ...
                              <tbody>
                                  <?php
                                    ...
                                    if(isset($_GET['search'])){
                                        ...
                                        $query = "SELECT * FROM `party` WHERE `is_deleted` = 0 AND `name_en` LIKE '{$search}%' ORDER BY `name_en`";
                                    } else {
