        ...
        <div class="container">
            <div class="row rowCenter align-items-center">
                <div class="col-12 text-center mt-5">
                    <h1 class="fingerprint mt-5">ඔබ දැනටමත් ඡන්දය දී ඇත</h1>
                    <h1 class="fingerprint mt-4 mb-4">நீங்கள் ஏற்கனவே வாக்களித்தீர்கள்</h1>
                    <h1 class="fingerprint mt-4 mb-5">you already voted</h1>
