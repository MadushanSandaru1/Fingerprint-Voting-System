        ...
        <div class="container">
            <div class="row rowCenter align-items-center">
                <div class="col-12 text-center mt-5">
                    <h1 class="fingerprint mt-5">වලංගු පරීක්ෂකවරයෙක් නොවේ</h1>
                    <h1 class="fingerprint mt-4 mb-4">செல்லுபடியாகும் ஆய்வாளர் அல்ல</h1>
                    <h1 class="fingerprint mt-4 mb-5">Not a valid inspector</h1>
