...
<html>
    <head>
        <title>FVS | Age Vote Error</title>
        ...
        <div class="container">
            <div class="row rowCenter align-items-center">
                <div class="col-12 text-center mt-5">
                    <h1 class="fingerprint mt-5">වයස අවුරුදු 18 ට අඩු අයට ඡන්දය භාවිතා කළ නොහැක</h1>
                    <h1 class="fingerprint mt-4 mb-4">18 வயதுக்கு உட்பட்டவர்கள் வாக்குகளை பயன்படுத்த முடியாது</h1>
                    <h1 class="fingerprint mt-4 mb-5">People under the age of 18 cannot use vote</h1>
                </div>
            </div>
        </div>
    </body>
